...
<li className = 'list'>check bios date, if older then a few months update the bios.</li>

<li className = 'list'>set hard drive to first in boot order,followed by network, and then cd in all the boot lists, remove the rest</li>

<li className = 'list'>make sure OS optimized default are set to enabled</li>

<li className = 'list'>go to network and turn off wireless if it is a pc</li>

<li className = 'list'>Go to uphappndc186\surgery-alt\newcomputer right click MakeUserAdmin and run powershell, follow prompts, add uphs\surgery information users for admin</li>
...
<li className = 'list'>Go to uphappndc186\surgery-alt\newcomputer right click RemoteUser and run powershell, follow prompts, add uphs\username, username is there log in name</li>

<li className = 'list'>Go to uphappndc186\surgery-alt\newcomputer right click MakeUserAdmin and run powershell, follow prompts, add uphs\who ever the user is if its a laptop</li>
...
<li className = 'list'>right click on backup and run with powershell and follow prompts, to bring old computer files over</li>

<li className = 'list'>c$ old computer get printers from drives in temp folder also look for any programs like adobe pro or dragon, if anything special ask Jason</li>
...
<li className = 'list'>Download Bluejeans app from https://www.bluejeans.com/downloads</li>
...
<li className = 'list'>At users desk, if it is a new pc name update Pennchart in lws editor, if a new pc put a ticket in</li>
</ol>
      </div>
   );
};
